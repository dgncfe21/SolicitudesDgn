...
var deltaLat;
var deltaLng;
var position = [25.67608870, -100.21918542]; //lat lon CEID
...
function initMap() { // Google Map Initialization... 
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: 16,
        center: new google.maps.LatLng(25.67608870, -100.21918542),
...
map.data.loadGeoJson('http://10.4.90.66:81/JsonFiles/CIclosZonaOrientev2.json');
map.data.setStyle({
  fillColor: 'green',
  strokeWeight: 2
});
...
var cars_Ref = firebase.database().ref('/INSTMEDS_OTE');


var dataConductores = firebase.database().ref('/INSTMEDS_OTE');
