...
function AddMarkerConductor(data) {
    ...
    let urlIcon = (conductor.situacion == "Disponible") ? 'torre128.png' : 'torre128.png';
...
function buildLococationConductoresList(data) {
    ...
    for (let i = 0; i < arraySize; i++) {
        ...
        link.className = 'name';
        link.dataPosition = i;
//<a href="https://www.flaticon.es/iconos-gratis/torre-de-electricidad" title="torre-de-electricidad iconos">Torre-de-electricidad iconos creados por photo3idea_studio - Flaticon</a>
        link.innerHTML =
            // '<img src=' + conductor.properties.imagetmb + '>' +
            '<img src="https://img.icons8.com/external-flat-juicy-fish/60/000000/external-power-vehicle-mechanics-flat-flat-juicy-fish-7.png"/>' +
